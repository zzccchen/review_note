...
#define LWI 1493 // 左轮初始值 Left Wheel Initial
...
unsigned char sendCmd3f[11] = {0xfe, 0x06, 0x93, 0x93, 0xfe, 0xfd, 0xfe, 0xfd, 0x01, 0x03, 0xff}; // 从机3发
...
int cardno[] = {237, 212, 29, 141, 244, 173, 237, 228, 164, 77, 173, 77, 205, 77, 205, 13, 109, 29, 244, 0}; // 卡号数组
void loop()
{
  static int step = 0;
...
{
  int time = 104 * (abs(angle) / 360.0); // 96 为转弯 360°所需的计数
  if (angle < 0)
