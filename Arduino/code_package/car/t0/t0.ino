...
int cardno[] = {212, 29, 244, 109, 189, 173, 253, 93, 173, 109, 253, 93, 189, 45, 189, 173, 228, 173, 93, 109, 228, 237, 0}; // 卡号数组
void loop()
{
  static int step = 0;
  ...
  switch (step) // 就位动作
  {
    case 0: case 1: case 3: case 5: case 6: case 11: case 19:
      WturnA(90);
      break;
    case 2:
      Sready(4);
    ...
    case 4:
      ...
      WturnA(-90);
      break;
    case 7: case 8: case 9: case 10: case 17:
      WturnA(-90);
      break;
    case 12:
      Sready(4);
...
void Sready(int nums) // 主机就位信号发送
{
  ...
  SerialRead(); // 清除缓冲区
  while ((status1 + status2 + status3 + status4) < nums) // nums
  {
    switch (SerialRead())
    {
      case 101:
...
{
  int time = 98.0 * (abs(angle) / 360.0); // 94 为转弯 360°所需的计数
  if (angle < 0)
