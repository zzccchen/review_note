...
#define LWI 1495 // 左轮初始值 Left Wheel Initial
#define MWI 1500 // 中轮初始值 Middle Wheel Initial
#define RWI 1505 // 右轮初始值 Right Wheel Initial
...
int cardno[] = {237, 212, 29, 244, 205, 84, 77, 13, 77, 141, 77, 13, 205, 253, 205, 189, 173, 237, 157, 109, 0}; // 卡号数组
void loop()
{
  static int step = 0;
  ...
  switch (step) // 就位动作
  {
    case 0: case 5: case 6: case 11: case 17: 
      WturnA(-90);
      break;
    case 1:
      WturnA(90);
...
{
  int time = 96.0 * (abs(angle) / 360.0); // 95 为转弯 360°所需的计数
  if (angle < 0)
