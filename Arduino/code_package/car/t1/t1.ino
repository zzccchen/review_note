...
#define RWI 1498 // 右轮初始值 Right Wheel Initial
...
unsigned char sendCmd1f[11] = {0xfe, 0x06, 0x93, 0x93, 0xfe, 0xfd, 0xfe, 0xfd, 0x01, 0x01, 0xff}; // 从机1发
...
int cardno[] = {237, 212, 29, 84, 244, 253, 52, 164, 228, 173, 45, 173, 77, 125, 212, 77, 109, 0}; // 卡号数组
void loop()
{
  static int step = 0;
...
{
  int time = 100 * (abs(angle) / 360.0); // 93.5 为转弯 360°所需的计数
  if (angle < 0)
